...
import {shopPublicHandler, shopAdminHandler} from '../src/shop.js';
...
export default async function apiIndex(req, res) {
  ...
  if (normalized === '/admin/shop') return shopAdminHandler(req, res);
  if (normalized === '/shop') return shopPublicHandler(req, res);
